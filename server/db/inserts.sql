...
INSERT INTO `massaia`.`authors` (`id`, `name`, `image`) VALUES ('42', 'Pedro Pereira', 'pedro-pereira.png');
INSERT INTO `massaia`.`authors` (`id`, `name`, `image`) VALUES ('43', 'Daniela Waitzmann ', 'Daniela-Waitzmann.jpg');
INSERT INTO `massaia`.`authors` (`id`, `name`, `image`, `title`) VALUES ('44', 'Álvaro Sousa ', 'Alvaro_perfilID-400x375.jpg', 'Criação, desenho ');
INSERT INTO `massaia`.`authors` (`id`, `name`, `image`, `title`) VALUES ('45', 'Rui Costa', 's200_rui.costa.jpg', 'Criação, desenho ');
INSERT INTO `massaia`.`authors` (`id`, `name`, `image`, `title`) VALUES ('46', 'Paulo Hernâni', 'B3996C27_D5F80768.jpg', 'Criação, pintura ');
INSERT INTO `massaia`.`authors` (`id`, `name`, `title`) VALUES ('47', 'Eduarda Ferreira ', 'Criação, pintura ');
INSERT INTO `massaia`.`authors` (`id`, `name`, `image`, `title`) VALUES ('48', 'Isaque Pinheiro', 'Isaque-Pinheiro.jpg', 'Criação, escultura ');
INSERT INTO `massaia`.`authors` (`id`, `name`, `image`, `title`) VALUES ('49', 'Inês Silva', '', 'Intérprete, canto ');
INSERT INTO `massaia`.`authors` (`id`, `name`, `image`, `title`) VALUES ('50', 'Sara Rodrigues', '', 'Intérprete, canto ');
INSERT INTO `massaia`.`authors` (`id`, `name`, `image`, `title`) VALUES ('51', 'Olinda Martins', 'olinda-martins.png', 'Criação gráfica ');
INSERT INTO `massaia`.`authors` (`id`, `name`, `title`) VALUES ('52', 'Diana Ferreira', 'Criação, animação de vídeo ');
INSERT INTO `massaia`.`authors` (`id`, `name`, `title`) VALUES ('53', 'Arnaldo Fonseca', 'Intérprete, acordeão');
INSERT INTO `massaia`.`authors` (`id`, `name`, `title`) VALUES ('54', 'Valentina Idini', 'Intérprete, canto ');
INSERT INTO `massaia`.`authors` (`id`, `name`, `title`) VALUES ('55', 'Fausto Pizzol ', 'Intérprete, baixo elétrico ');
...
UPDATE `massaia`.`authors` SET `image` = 'carlos_silva.png' WHERE (`id` = '5');
UPDATE `massaia`.`authors` SET `image` = 'antonio_silva.png' WHERE (`id` = '7');
UPDATE `massaia`.`authors` SET `image` = 'joana-araujo.png' WHERE (`id` = '15');
UPDATE `massaia`.`authors` SET `image` = 'Nuno-Aragao.jpg' WHERE (`id` = '9');
UPDATE `massaia`.`authors` SET `image` = 'Brendan_Hemsworth.jpg' WHERE (`id` = '8');
UPDATE `massaia`.`authors` SET `image` = 'Antonio-Silva.jpg' WHERE (`id` = '7');
UPDATE `massaia`.`authors` SET `image` = 'isabel_calado.jpg' WHERE (`id` = '29');
UPDATE `massaia`.`authors` SET `name` = 'Tiago M. Soares', `image` = 'Tiago-Soares.jpg' WHERE (`id` = '36');
UPDATE `massaia`.`authors` SET `name` = 'Helena Rodrigues' WHERE (`id` = '35');
UPDATE `massaia`.`authors` SET `name` = 'Pedro Lima Pereira' WHERE (`id` = '42');
UPDATE `massaia`.`authors` SET `title` = 'criação, desenho ' WHERE (`id` = '4');
UPDATE `massaia`.`authors` SET `title` = 'Criação e animação, corealização de Vídeo ' WHERE (`id` = '5');
UPDATE `massaia`.`authors` SET `title` = 'Coprodução de vídeo' WHERE (`id` = '6');
UPDATE `massaia`.`authors` SET `title` = 'Masterização de som ' WHERE (`id` = '7');
UPDATE `massaia`.`authors` SET `title` = 'Criação, produção e mistura ' WHERE (`id` = '8');
UPDATE `massaia`.`authors` SET `title` = 'Captação e gravação de Som ' WHERE (`id` = '9');
UPDATE `massaia`.`authors` SET `title` = 'Captação e gravação de Som' WHERE (`id` = '10');
UPDATE `massaia`.`authors` SET `title` = 'Captação e gravação de Som' WHERE (`id` = '11');
UPDATE `massaia`.`authors` SET `title` = 'Intérprete, canto ' WHERE (`id` = '12');
UPDATE `massaia`.`authors` SET `title` = 'Intérprete, canto ' WHERE (`id` = '13');
UPDATE `massaia`.`authors` SET `title` = 'Intérprete, canto ' WHERE (`id` = '14');
UPDATE `massaia`.`authors` SET `title` = 'Intérprete, canto ' WHERE (`id` = '15');
UPDATE `massaia`.`authors` SET `title` = 'Criação, artes plásticas  ' WHERE (`id` = '18');
UPDATE `massaia`.`authors` SET `title` = 'Criação, escultura ' WHERE (`id` = '20');
UPDATE `massaia`.`authors` SET `title` = 'Criação, escultura ' WHERE (`id` = '23');
UPDATE `massaia`.`authors` SET `title` = 'Intérprete, saxofones ' WHERE (`id` = '26');
UPDATE `massaia`.`authors` SET `title` = 'Criação, pintura ' WHERE (`id` = '27');
UPDATE `massaia`.`authors` SET `title` = 'Criação, desenho ' WHERE (`id` = '28');
UPDATE `massaia`.`authors` SET `title` = 'Criação, fotografia ' WHERE (`id` = '29');
UPDATE `massaia`.`authors` SET `title` = 'Criação, pintura ' WHERE (`id` = '30');
UPDATE `massaia`.`authors` SET `title` = 'desenho, pintura e algário ' WHERE (`id` = '31');
UPDATE `massaia`.`authors` SET `title` = 'Intérprete, contrabaixo ' WHERE (`id` = '32');
UPDATE `massaia`.`authors` SET `title` = 'Fotografia e prefácio ' WHERE (`id` = '33');
UPDATE `massaia`.`authors` SET `title` = 'Criação, pintura ' WHERE (`id` = '34');
UPDATE `massaia`.`authors` SET `title` = 'Criação literária e intérprete ' WHERE (`id` = '35');
UPDATE `massaia`.`authors` SET `title` = 'Intérprete, percussão ' WHERE (`id` = '36');
UPDATE `massaia`.`authors` SET `title` = 'Criação, desenho e colagem ' WHERE (`id` = '37');
UPDATE `massaia`.`authors` SET `title` = 'Criação, pintura ' WHERE (`id` = '38');
UPDATE `massaia`.`authors` SET `title` = 'Criação e interpretação musical ' WHERE (`id` = '39');
UPDATE `massaia`.`authors` SET `title` = 'Intérprete, guitarra acústica ' WHERE (`id` = '41');
UPDATE `massaia`.`authors` SET `title` = 'Intérprete, guitarras ' WHERE (`id` = '42');
UPDATE `massaia`.`authors` SET `title` = 'Criação, pintura ' WHERE (`id` = '43');
UPDATE `massaia`.`authors` SET `image` = 'Alvaro-Sousa.png' WHERE (`id` = '44');
